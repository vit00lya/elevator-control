...
В программе создаются логи по пути \data\logs. Длина очереди 100 событий, после наступления этого добавляется новый файл с логом.

### При разработке использовались библиотеки:

Для работы необходимо собрать и установить вот эту библиотеку в систему [log-it-cpp](https://github.com/NewYaroslav/log-it-cpp/)
